...
UNKNOWN_COMMAND = 'The command `{command}` does not exist. Use `!help` to see all available commands.'
...
BOT_RESTART_CONFIRM   = 'React to confirm the restart.'
BOT_RESTART_CANCELLED = 'Restart cancelled.'
BOT_RESTARTING        = 'Restarting, back in a moment...'
